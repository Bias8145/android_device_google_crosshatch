...
include device/google/blueline/device-common.mk

DEVICE_PACKAGE_OVERLAYS += device/google/blueline/overlay_blueline
...
PRODUCT_COPY_FILES += \
    device/google/blueline/nfc/libnfc-nxp.blueline.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nxp.conf \
    device/google/blueline/nfc/libnfc-nxp.blueline.uicc.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nxp-G013A.conf \
    device/google/blueline/nfc/libnfc-nxp.blueline.ese.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nxp-G013B.conf
