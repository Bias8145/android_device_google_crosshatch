...
TARGET_BOARD_INFO_FILE := device/google/blueline/board-info.txt
...
TARGET_BOARD_COMMON_PATH := device/google/blueline/sdm845
...
TARGET_RECOVERY_WIPE := device/google/blueline/recovery.wipe
ifneq ($(filter %_mainline,$(TARGET_PRODUCT)),)
TARGET_RECOVERY_FSTAB := device/google/blueline/fstab.mainline.hardware
else
TARGET_RECOVERY_FSTAB := device/google/blueline/fstab.hardware
endif
...
include device/google/blueline/sepolicy/crosshatch-sepolicy.mk

TARGET_FS_CONFIG_GEN := device/google/blueline/config.fs
...
DEVICE_MANIFEST_FILE := device/google/blueline/manifest.xml
DEVICE_MATRIX_FILE := device/google/blueline/compatibility_matrix.xml
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE := device/google/blueline/device_framework_matrix.xml
...
ODM_MANIFEST_G013A_FILES := device/google/blueline/nfc/manifest_se_SIM1.xml
ODM_MANIFEST_G013B_FILES := device/google/blueline/nfc/manifest_se_eSE1.xml
ODM_MANIFEST_G013C_FILES := device/google/blueline/nfc/manifest_se_SIM1.xml
ODM_MANIFEST_G013D_FILES := device/google/blueline/nfc/manifest_se_eSE1.xml
