...
include device/google/blueline/device.mk
...
# Modem loging file
PRODUCT_COPY_FILES += \
    device/google/blueline/init.logging.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.$(PRODUCT_PLATFORM).logging.rc

# whitelisted app
PRODUCT_COPY_FILES += \
    device/google/blueline/qti_whitelist.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/qti_whitelist.xml
